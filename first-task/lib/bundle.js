...
var _News = __webpack_require__(330);

var _News2 = _interopRequireDefault(_News);

var _Sources = __webpack_require__(331);
...
(0, _jquery2.default)(document).ready(function () {
    ...
    sources.getSources().then(function (sources) {
...
function getSelectedOptions() {
    var $sourcesBlock = (0, _jquery2.default)('#sources option:selected');
    var result = [];
    ...
    try {
        for (var _iterator2 = $sourcesBlock[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
