...
var _news = __webpack_require__(331);

var _news2 = _interopRequireDefault(_news);

var _sources = __webpack_require__(332);

var _sources2 = _interopRequireDefault(_sources);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var key = '80df597e0ca14ef6894565929343e289';
var host = 'https://newsapi.org/v2/';
var optionForSources = {
    key: key,
    url: host + 'sources?apiKey=' + key
};
var sources = new _sources2.default(optionForSources);

var optionForNews = {
    key: key
};
var news = new _news2.default(optionForNews);

(0, _jquery2.default)(document).ready(function () {
    var $sourcesBlock = (0, _jquery2.default)('#sources');
    sources.get().then(function (sources) {
        ...
        try {
            for (var _iterator = sources[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                var option = (0, _jquery2.default)('<option value="' + source.id + '">' + source.name + '</option>');
...
function btnShow() {
    var $error = (0, _jquery2.default)('#error');
...
function getSelectedOptions() {
    var $selectedOptions = (0, _jquery2.default)('#sources option:selected');
    var result = [];
...
function renderNews() {
    news.get().then(function (news) {
        var $newsBlock = (0, _jquery2.default)('#news');
        $newsBlock.empty();
        ...
        try {
            for (var _iterator3 = news[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                var $articleBlock = (0, _jquery2.default)("<div class='cell small-4'></div>");
                var author = article.author ? '<small class=\'label secondary\'>' + article.author + '</small>' : '';
                $articleBlock.append((0, _jquery2.default)('<h5><a href=\'' + article.url + '\'>' + article.title + '</a> ' + author + '</h5>'));
                $articleBlock.append((0, _jquery2.default)('<p>' + (article.description || '') + '</p>'));
                $articleBlock.append((0, _jquery2.default)('<a class=\'clear button\' href=\'' + article.url + '\'>Read more</a>'));
...
var News = function (_Retriever) {
    _inherits(News, _Retriever);
    ...
    _createClass(News, [{
        key: 'get',
        value: function get() {
            return _get(News.prototype.__proto__ || Object.getPrototypeOf(News.prototype), 'get', this).call(this).then(function (response) {
...
var Sources = function (_Retriever) {
    _inherits(Sources, _Retriever);

    function Sources(options) {
        _classCallCheck(this, Sources);

        var _this = _possibleConstructorReturn(this, (Sources.__proto__ || Object.getPrototypeOf(Sources)).call(this, options));
    ...
    _createClass(Sources, [{
        key: 'get',
        value: function get() {
            return _get(Sources.prototype.__proto__ || Object.getPrototypeOf(Sources.prototype), 'get', this).call(this).then(function (response) {
